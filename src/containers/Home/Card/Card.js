			...
			<div className="flex overflow-hidden h-72">
				...
				<div className="w-1/2 p-4 pl-10 pt-10">
					...
					<p className="mt-2 text-gray-500 ">
						No matter how type 1 diabetes has shown up in your life,
						you can find success by balancing your medications, and
						sticking to your daily exercise routine and nutrition
						plan.
					</p>
